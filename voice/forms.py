...
class VoiceAgentSettingsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "emotion_mode": forms.Select(attrs={"class": _SELECT}),
            "emotion_intensity": forms.Select(attrs={"class": _SELECT}),
            "fixed_emotion": forms.Select(attrs={"class": _SELECT}),
