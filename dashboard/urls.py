...
urlpatterns = [
    ...
    path("settings/blocked/", views.blocked_times, name="blocked_times"),
    path("settings/blocked/create/", views.create_blocked_time, name="create_blocked_time"),
    path("settings/blocked/<int:pk>/delete/", views.delete_blocked_time, name="delete_blocked_time"),
