...
urlpatterns = [
    ...
    path("appointments/<int:pk>/yakap-status/", views.update_appointment_yakap_status, name="update_appointment_yakap_status"),
    ...
    path("patients/<int:pk>/yakap-profile/", views.update_patient_yakap_profile, name="update_patient_yakap_profile"),
