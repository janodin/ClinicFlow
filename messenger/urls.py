...
urlpatterns = [
    ...
    path("ai/turn/register/", views.ai_turn_register, name="ai_turn_register"),
    ...
    path("ai/turn/authorize-send/", views.ai_turn_authorize_send, name="ai_turn_authorize_send"),
    path("ai/turn/send-reply/", views.ai_turn_send_reply, name="ai_turn_send_reply"),
