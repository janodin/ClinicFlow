...
5. Run `python manage.py check --deploy` before release and treat all warnings/errors as blocking unless the deployment runbook explicitly documents why a specific warning is accepted.
